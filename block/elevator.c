...
/*
 * For blk-mq devices, we use the default scheduler from defconfig, if available, for single
 * queue devices. If the default scheduler isn't available/set OR we have multiple queues,
 * default to "none".
 */
